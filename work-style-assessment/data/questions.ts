...
export const questions: Question[] = [
  ...
  // ========== 模块2：防御性 & 攻击风险指数 ==========
  {
    ...
    options: [
      { id: 'A', text: '继续补充信息，希望对方理解', scores: { defense: 0 } },
      { id: 'B', text: '接受结果，观察后续发展', scores: { defense: 0 } },
      { id: 'C', text: '觉得对方并没有真正理解问题', scores: { defense: 4 } },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: '提出不同意见但服从结果', scores: { defense: 0 } },
      { id: 'C', text: '表面接受，内心保留判断', scores: { defense: 4 } },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: '问题本身是否成立', scores: { defense: 0 } },
      { id: 'B', text: '如何快速修正', scores: { defense: 0 } },
      { id: 'C', text: '对方是否理解你的初衷', scores: { defense: 4 } },
